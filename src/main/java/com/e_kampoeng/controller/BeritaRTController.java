...
import com.e_kampoeng.service.BeritaRTService;
...
@RestController
@RequestMapping("/e-kampoeng/api/berita-rt")
@CrossOrigin(origins = "*")
public class BeritaRTController {

    @Autowired
    private BeritaRTService beritaRTService;
    ...
    public ResponseEntity<CommonResponse<Berita>> createberita2(BeritaDTO berita, @RequestPart("file")MultipartFile multipartFile) throws SQLException, ClassNotFoundException {
        ...
        try {
            Berita berita1 = beritaRTService.save(berita, multipartFile);
    ...
    public ResponseEntity<CommonResponse<Page<Berita>>> listAllBerita(
        ...
        try {
            Page<Berita> beritaPage = beritaRTService.findAllWithPagination(pageable);
            response.setStatus("success");
    ...
    public ResponseEntity<CommonResponse<Berita>> updateBerita(@PathVariable("id") Long id, BeritaDTO berita, @RequestPart("file") MultipartFile multipartFile) throws SQLException, ClassNotFoundException {
        CommonResponse<Berita> response = new CommonResponse<>();
        try {
            Optional<Berita> currentBerita = beritaRTService.findById(id);
            ...
            Berita berita1 = beritaRTService.update(id, berita, multipartFile);
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(berita1);
    ...
    public ResponseEntity<CommonResponse<List<Berita>>> listBeritaTerbaru() throws SQLException, ClassNotFoundException {
        ...
        try {
            List<Berita> berita = beritaRTService.beritaTerbaru();
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
    ...
    public ResponseEntity<CommonResponse<List<Berita>>> searchBerita(@RequestParam("search") String judul) {
        CommonResponse<List<Berita>> response = new CommonResponse<>();
        try {
            List<Berita> beritas = beritaRTService.searchBerita(judul);
            if(beritas.isEmpty()) {
    ...
    public ResponseEntity<CommonResponse<List<Berita>>> listBeritaArsip(@RequestParam("bulan") String bulan) throws SQLException, ClassNotFoundException {
        CommonResponse<List<Berita>> response = new CommonResponse<>();
        try {
            List<Berita> berita = beritaRTService.arsip(bulan);
            if(berita.isEmpty()) {
                response.setStatus("not found");
                response.setCode(HttpStatus.NOT_FOUND.value());
                response.setData(null);
    ...
    public ResponseEntity<CommonResponse<Berita>> get(@PathVariable("id") long id) throws SQLException, ClassNotFoundException {
        CommonResponse<Berita> response = new CommonResponse<>();
        try {
            Berita berita1 = beritaRTService.getBeritaById(id);
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(berita1);
    ...
    public ResponseEntity<CommonResponse<Page<Berita>>> allByCategory(
        ...
        try {
            ...
            Page<Berita> beritas = beritaRTService.getByCategory(categoryId, pageable);
    ...
    public ResponseEntity<CommonResponse<List<Berita>>> relatedPosts(@RequestParam("id") Long id) {
        CommonResponse<List<Berita>> response = new CommonResponse<>();
        try {
            List<Berita> beritas = beritaRTService.relatedPosts(id);
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(beritas);
            response.setMessage("Berita list retrieved successfully.");
    ...
    public ResponseEntity<CommonResponse<List<Berita>>> beritaTerbaruByCategory(@RequestParam("categoryId") Long categoryId) {
        CommonResponse<List<Berita>> response = new CommonResponse<>();
        try {
            List<Berita> beritas = beritaRTService.terbaruByCategory(categoryId);
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(beritas);
            response.setMessage("Berita list retrieved successfully.");
